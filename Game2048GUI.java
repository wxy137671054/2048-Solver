/* 
	...
	Class: ICS3U1-02
	Date: June 10, 2014
	Description: This program creates the gui of the game 2048.	It reads in the address of a game logo and number tiles from 
	a txt file. It also outputs the game board with number tiles on it.
*/
   import javax.swing.*;
       ...
       private void initConfig()
      {
       ...
       // TO DO:  initialize the following variables with information read from the config file
         ...
         //	Create a new bufferedreader to read in the file
            ...
            //the first one is logo
            logoIconFile=in.readLine();
         	
         	//then it reads in number of tiles
            int numTiles=Integer.parseInt(in.readLine());
         	
            //create an array to store the address.
            slotIconFile=new String[numTiles];
